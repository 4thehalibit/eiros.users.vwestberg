{ config, lib, ... }:
{
  ...
  config.eiros.users.vwestberg.mangowc.keybinds = {
    ...
    keybinds_cheatsheet = { modifier_keys = [ "SUPER" ]; flag_modifiers = [ "s" ]; key_symbol = "F1"; mangowc_command = "spawn"; command_arguments = "ghostty --class=keybinds-popup -e keybinds-popup"; };
